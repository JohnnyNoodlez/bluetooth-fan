"""Tests for bluetooth_fan api."""
import asyncio

import aiohttp
from homeassistant.helpers.aiohttp_client import async_get_clientsession

from custom_components.bluetooth_fan.api import BluetoothFanApiClient
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = BluetoothFanApiClient("test", "test", async_get_clientsession(hass))
